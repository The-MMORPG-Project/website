...
5. Note that you will need to setup the web server when testing the 'Play' button (or temporarily comment out the communication to the web server and provide your own latest.zip test file)
